-- ============================================================
--  Trailhead — OPTIONAL demo seed (run AFTER neon-setup.sql)
--  Logins (all password: password123):
--    admin@example.com    (admin)
--    leader@example.com   (leader — receives & starts parent submissions)
--    web@example.com      (web setup, optional specialist)
--    finance@example.com  (finance — confirms payment & approves)
--  The final SELECT shows your troop invite/intake code.
-- ============================================================
...
DECLARE
  ...
  pw   text := '$2a$10$ltY9Yhr5VI478xvTIJMqPuYDDGmB93NIWlno2J/S6PexgMbxjbtPG';
BEGIN
  ...
  INSERT INTO users (troop_id, email, password_hash, name, role) VALUES
    ...
    (t_id, 'leader@example.com',  pw, 'Laura Leader',  'leader'),
  ...
  INSERT INTO scout_events (scout_id, actor, action, to_status) VALUES
    ...
    (s_id, 'Laura Leader', 'Review & start setup', 'web_setup');
  ...
  INSERT INTO scout_events (scout_id, actor, action, to_status) VALUES
    (s_id, 'Parent intake', 'Submitted via intake link', 'submitted'),
    (s_id, 'Laura Leader', 'Review & start setup', 'web_setup'),
    (s_id, 'Laura Leader', 'Sent to finance', 'finance');
